...
def test_describe_hpo_job_success(mock_sagemaker):
    ...
    mock_sagemaker.describe_hyper_parameter_tuning_job.assert_called_with(HyperParameterTuningJobName=hpo_job_name)
...
def test_describe_hpo_job_client_error(mock_sagemaker):
    ...
    mock_sagemaker.describe_hyper_parameter_tuning_job.side_effect = ClientError(error_msg, "DescribeHyperParameterTuningJob")
