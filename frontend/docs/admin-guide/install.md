...
| `AUTH_OIDC_CLIENT_SECRET_NAME`                   | The name of the AWS Secrets Manager secret where the OIDC client secret is stored (required for confidential clients only)                                                                                                                                                                                                                               | `mlspace/auth/oidc-client-secret` |
| `AUTH_OIDC_CLIENT_SECRET_VALUE`                  | Optional OIDC client secret value for deployment-time configuration if using a confidential client.                                                                                                                                                                                                                               |                                          - |
