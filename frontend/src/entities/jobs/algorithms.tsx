...
import linearLearnerMetadata from '../../shared/algorithmMetadata/linearLearner.json';
...
export const ML_ALGORITHMS: Algorithm[] = [
    ...
    },
    {
        ...
        name: 'linear-learner',
        metadata: linearLearnerMetadata as AlgorithmMetadata,
        defaultHyperParameters: [{
            key: 'feature_dim',
            value: [],
            ...staticParameterProperties,
        ...
        {
            key: 'margin',
            value: ['The margin for the hinge_loss function.'],
            ...staticParameterProperties,
        ...
        },
        {
            ...
            description: 'The weight decay parameter, also known as the L2 regularization parameter. If you don\'t want to use L2 regularization, set the value to 0.',
        },
        {
            key: 'l1',
            value: [],
            ...
            description: 'The L1 regularization parameter. If you don\'t want to use L1 regularization, set the value to 0.',
        },
        {
            key: 'momentum',
            value: [],
        ...
        },
        {
            ...
            description: 'The step size used by the optimizer for parameter updates.',
        },
        {
            key: 'beta_1',
            value: ['0.9'],
        ...
        {
            // Can be 'balanced', 'auto', or a float. Static and Categorical are only balanced and auto. Continuous is only float
            ...
            type: HyperparameterType.CONTINUOUS,
            typeOptions: [HyperparameterType.CATEGORICAL, HyperparameterType.CONTINUOUS, HyperparameterType.STATIC],
            scalingType: 'Logarithmic',
            zValidator: numberValidator('positive_example_weight_mult', { min: 0, includeMin: false, isFloat: true, alternateValues: ['balanced', 'auto'] }),
            description: 'The weight assigned to positive examples when training a binary classifier. The weight of negative examples is fixed at 1. If you want the algorithm to choose a weight so that errors in classifying negative vs. positive examples have equal impact on training loss, specify balanced. If you want the algorithm to choose the weight that optimizes performance, specify auto.',
        },
        {
            key: 'num_classes',
            value: [],
